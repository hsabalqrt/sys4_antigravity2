...
- `filament-development` — Develops administrative interfaces using Filament v3. Activates when creating or modifying Filament resources, pages, widgets, clusters, or relation managers; working with form() and table() methods; adding actions, bulk actions, or filters; configuring navigation; using the search-docs tool for Filament; or when the user mentions Filament, resource, dashboard, or admin panel.
